...
namespace android.widget {
    ...
    export class TimePicker extends android.widget.FrameLayout {
         ...
         * the code.
         */
        private static NO_OP_CHANGE_LISTENER: android.widget.TimePicker.OnTimeChangedListener = new class implements android.widget.TimePicker.OnTimeChangedListener {
        ...
        // ui components
        private mHourSpinner: android.widget.NumberPicker;

        private mMinuteSpinner: android.widget.NumberPicker;

        private mAmPmSpinner: android.widget.NumberPicker;

        private mHourSpinnerInput: android.widget.EditText;

        private mMinuteSpinnerInput: android.widget.EditText;

        private mAmPmSpinnerInput: android.widget.EditText;

        private mDivider: android.widget.TextView;

        // Note that the legacy implementation of the TimePicker is
        // using a button for toggling between AM/PM while the new
        // version uses a NumberPicker spinner. Therefore the code
        // accommodates these two cases to be backwards compatible.
        private mAmPmButton: android.widget.Button;
        ...
        // callbacks
        private mOnTimeChangedListener: android.widget.TimePicker.OnTimeChangedListener;
        ...
        constructor(context: Context, attrs: AttributeSet, defStyle: number) {
            ...
            // hour
            mHourSpinner = <android.widget.NumberPicker>findViewById(R.id.hour);
            mHourSpinner.setOnValueChangedListener(((__this) => new class implements android.widget.NumberPicker.OnValueChangeListener {

                public onValueChange(spinner: android.widget.NumberPicker, oldVal: number, newVal: number): void {
                    updateInputState();
                    if (!is24HourView()) {
            ...
            mHourSpinnerInput = <android.widget.EditText>mHourSpinner.findViewById(R.id.numberpicker_input);
            mHourSpinnerInput.setImeOptions(EditorInfo.IME_ACTION_NEXT);
            // divider (only for the new widget style)
            mDivider = <android.widget.TextView>findViewById(R.id.divider);
            if (mDivider !== null) {
                setDividerText();
            }
            // minute
            mMinuteSpinner = <android.widget.NumberPicker>findViewById(R.id.minute);
            mMinuteSpinner.setMinValue(0);
            mMinuteSpinner.setMaxValue(59);
            mMinuteSpinner.setOnLongPressUpdateInterval(100);
            mMinuteSpinner.setFormatter(NumberPicker.getTwoDigitFormatter());
            mMinuteSpinner.setOnValueChangedListener(((__this) => new class implements android.widget.NumberPicker.OnValueChangeListener {
            ...
            mMinuteSpinnerInput = <android.widget.EditText>mMinuteSpinner.findViewById(R.id.numberpicker_input);
            ...
            if (amPmView instanceof android.widget.Button) {
                ...
                mAmPmSpinnerInput = <android.widget.EditText>mAmPmSpinner.findViewById(R.id.numberpicker_input);
         ...
         */
        public setOnTimeChangedListener(onTimeChangedListener: android.widget.TimePicker.OnTimeChangedListener): void {
    ...
    export module TimePicker {
        ...
        export interface OnTimeChangedListener {
             ...
             */
            onTimeChanged(view: android.widget.TimePicker, hourOfDay: number, minute: number): void;
        }
    }
